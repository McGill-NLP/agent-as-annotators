...
This script creates A3-Synth task configs from WebArena task files, converting them
into the format expected by the A3-Synth benchmark. The output files will be saved
in agent_as_annotators/benchmarks/A3-Synth/configs/ directory.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="agent_as_annotators/configs/exploration.tasks.json",
        help="Path to exploration config file, which will be used to get the persona and start url"
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default="agent_as_annotators/configs/A3-Synth/",
